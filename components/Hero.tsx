    ...
    <div className="relative h-screen min-h-[700px] w-full overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center px-6">
        ...
        <div className="max-w-5xl w-full flex flex-col items-center justify-center text-center">
          ...
          {/* Subcopy */}
          <p className="text-white/90 font-sans text-sm md:text-lg leading-loose tracking-wider max-w-3xl drop-shadow-md mb-10">
            大型犬も歓迎する全棟プライベートドッグラン・温泉付きのヴィラ。<br className="hidden md:block"/>
            誰にも邪魔されない、大切な家族との至福のひととき。
          </p>
          
          {/* Additional Description */}
          <p className="text-white/80 font-sans text-base md:text-lg font-bold leading-loose tracking-wider max-w-3xl drop-shadow-md">
